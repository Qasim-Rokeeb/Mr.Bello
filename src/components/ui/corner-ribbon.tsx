...
export function CornerRibbon({ text, className }: CornerRibbonProps) {
  return (
    <div
      className={cn(
        "group/ribbon pointer-events-none absolute -top-10 -right-10 z-10 h-28 w-28 overflow-hidden",
        className
      )}
    >
      <div className="holographic-background absolute top-0 left-0 h-full w-full shadow-md"></div>
      <div
