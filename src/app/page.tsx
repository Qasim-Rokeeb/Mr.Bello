      ...
      <main className="flex-1 pt-16">
                    ...
                    <CarouselItem key={i}>
                      <div className="p-1">
                        <GradientBorder active className="bg-card h-full">
                            <Card className="flex flex-col justify-between p-6 bg-transparent h-full border-none shadow-none" onClick={() => {}}>
                                <Quote className="h-8 w-8 text-primary/30 mb-4" />
                                <p className="text-muted-foreground flex-1 mb-6">"{t.quote}"</p>
                                <div className="flex items-center gap-4">
                                  <Avatar className="h-12 w-12 animate-shimmer bg-gradient-to-r from-primary via-blue-400 to-primary bg-[length:200%_100%]">
        ...
        <section className="py-20 bg-muted">
          <div className="container">
            <div className="bg-card p-10 md:p-16 rounded-[1rem] shadow-xl max-w-4xl mx-auto border animate-in fade-in zoom-in-95 duration-500" onClick={() => {}}>
                    ...
                    <form className="flex flex-col sm:flex-row gap-3">
                        <div className="relative flex-1">
                            <Input
                                ...
                                type="email"
                                placeholder=" " 
                                className="peer h-12 text-base transition-all duration-300 focus:w-[110%] focus-visible:w-[110%]"
                                required
                            />
                            <label 
                                htmlFor="email"
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <Button asChild size="icon" className="h-14 w-14 rounded-full shadow-2xl">
          <Link href="/chat" className="relative flex h-full w-full items-center justify-center">
            <span className="absolute h-full w-full rounded-full bg-primary animate-heartbeat opacity-75"></span>
