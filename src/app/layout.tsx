  ...
  return (
    <html lang="en" suppressHydrationWarning>
       ...
       <meta name="google-site-verification" content="S4BXCgKSgJyFAhOJS_P8ojh9VFpAVHYo0b9mTyGN8uM" />
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Inter+Tight:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500;1,600;1,700&display=swap"
          rel="stylesheet"
        />
      </head>
